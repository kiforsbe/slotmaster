...
export const FREQUENCY_REEL1 = {
  defaults: { maxStack: 4, minStack: 2, stackChance: 0.10, minFrequency: 0.005, maxFrequency: 0.500 },
  symbols: {
    cottoncandy: { frequency: 0.09612 },
    gum:         { frequency: 0.05026 },
    crystal:     { frequency: 0.03966 },
    rocket:      { frequency: 0.05501 },
    crown:       { frequency: 0.01367 },
    cake:        { frequency: 0.1282 },
    mint:        { frequency: 0.0933 },
    gummy:       { frequency: 0.1427 },
    bean:        { frequency: 0.06086 },
    chocolate:   { frequency: 0.06407 },
    chewy:       { frequency: 0.06749 },
    cherry:      { frequency: 0.08863 },
    bonus:       { frequency: 0.006396, minGap: 8, maxStack: 1, minStack: 1, maxFrequency: 0.025 },
  },
};
...
export const FREQUENCY_REEL2 = {
  defaults: { maxStack: 4, minStack: 2, stackChance: 0.10, minFrequency: 0.005, maxFrequency: 0.500 },
  symbols: {
    cottoncandy: { frequency: 0.01487 },
    gum:         { frequency: 0.0144 },
    crystal:     { frequency: 0.06094 },
    rocket:      { frequency: 0.07211 },
    crown:       { frequency: 0.05865 },
    cake:        { frequency: 0.0432 },
    mint:        { frequency: 0.0296 },
    gummy:       { frequency: 0.07013 },
    bean:        { frequency: 0.01754 },
    chocolate:   { frequency: 0.4433 },
    chewy:       { frequency: 0.04863 },
    cherry:      { frequency: 0.02676 },
    bonus:       { frequency: 0.006396, minGap: 8, maxStack: 1, minStack: 1, maxFrequency: 0.025 },
  },
};
...
export const FREQUENCY_REEL3 = {
  defaults: { maxStack: 4, minStack: 2, stackChance: 0.10, minFrequency: 0.005, maxFrequency: 0.500 },
  symbols: {
    cottoncandy: { frequency: 0.02328 },
    gum:         { frequency: 0.03978 },
    crystal:     { frequency: 0.05185 },
    rocket:      { frequency: 0.04271 },
    crown:       { frequency: 0.02897 },
    cake:        { frequency: 0.0145 },
    mint:        { frequency: 0.03091 },
    gummy:       { frequency: 0.04543 },
    bean:        { frequency: 0.02952 },
    chocolate:   { frequency: 0.1046 },
    chewy:       { frequency: 0.01851 },
    cherry:      { frequency: 0.07 },
    bonus:       { frequency: 0.006396, minGap: 8, maxStack: 1, minStack: 1, maxFrequency: 0.025 },
  },
};
...
export const FREQUENCY_REEL4 = {
  defaults: { maxStack: 4, minStack: 2, stackChance: 0.10, minFrequency: 0.005, maxFrequency: 0.500 },
  symbols: {
    cottoncandy: { frequency: 0.08536 },
    gum:         { frequency: 0.07508 },
    crystal:     { frequency: 0.1356 },
    rocket:      { frequency: 0.07958 },
    crown:       { frequency: 0.07633 },
    cake:        { frequency: 0.01507 },
    mint:        { frequency: 0.1541 },
    gummy:       { frequency: 0.004706 },
    bean:        { frequency: 0.01075 },
    chocolate:   { frequency: 0.08421 },
    chewy:       { frequency: 0.05624 },
    cherry:      { frequency: 0.1229 },
    bonus:       { frequency: 0.006396, minGap: 8, maxStack: 1, minStack: 1, maxFrequency: 0.025 },
  },
};
...
export const FREQUENCY_REEL5 = {
  defaults: { maxStack: 4, minStack: 2, stackChance: 0.10, minFrequency: 0.005, maxFrequency: 0.500 },
  symbols: {
    cottoncandy: { frequency: 0.1321 },
    gum:         { frequency: 0.2192 },
    crystal:     { frequency: 0.05255 },
    rocket:      { frequency: 0.06416 },
    crown:       { frequency: 0.05822 },
    cake:        { frequency: 0.03365 },
    mint:        { frequency: 0.04606 },
    gummy:       { frequency: 0.07048 },
    bean:        { frequency: 0.0364 },
    chocolate:   { frequency: 0.07617 },
    chewy:       { frequency: 0.09449 },
    cherry:      { frequency: 0.01643 },
    bonus:       { frequency: 0.006396, minGap: 8, maxStack: 1, minStack: 1, maxFrequency: 0.025 },
  },
};

export const FREQUENCY_REEL6 = {
  defaults: { maxStack: 4, minStack: 2, minFrequency: 0.005, maxFrequency: 0.500 },
  symbols: {
    cottoncandy: { frequency: 0.08856 },
    gum:         { frequency: 0.1043 },
    crystal:     { frequency: 0.04945 },
    rocket:      { frequency: 0.06016 },
    crown:       { frequency: 0.0556 },
    cake:        { frequency: 0.07065 },
    mint:        { frequency: 0.1134 },
    gummy:       { frequency: 0.07295 },
    bean:        { frequency: 0.08462 },
    chocolate:   { frequency: 0.04497 },
    chewy:       { frequency: 0.06711 },
    cherry:      { frequency: 0.08819 },
    bonus:       { frequency: 0.006396, minGap: 8, maxStack: 1, minStack: 1, maxFrequency: 0.025 },
  },
};
...
export const FREQUENCY_REEL7 = {
  defaults: { maxStack: 4, minStack: 2, minFrequency: 0.005, maxFrequency: 0.500 },
  symbols: {
    cottoncandy: { frequency: 0.05715 },
    gum:         { frequency: 0.0629 },
    crystal:     { frequency: 0.08911 },
    rocket:      { frequency: 0.1018 },
    crown:       { frequency: 0.129 },
    cake:        { frequency: 0.0754 },
    mint:        { frequency: 0.0405 },
    gummy:       { frequency: 0.06872 },
    bean:        { frequency: 0.1021 },
    chocolate:   { frequency: 0.0598 },
    chewy:       { frequency: 0.03025 },
    cherry:      { frequency: 0.08341 },
    bonus:       { frequency: 0.006396, minGap: 8, maxStack: 1, minStack: 1, maxFrequency: 0.025 },
  },
};
