...
export const FREQUENCY_REEL1 = {
  ...
  symbols: {
    ...
    pear:       { frequency: 12.42 },
    melon:      { frequency: 16.65 },
    grapes:     { frequency: 3.896 },
...
export const FREQUENCY_REEL2 = {
  ...
  symbols: {
    ...
    pear:       { frequency: 10.7 },
    melon:      { frequency: 11.24 },
    grapes:     { frequency: 12.34 },
...
export const FREQUENCY_REEL3 = {
  ...
  symbols: {
    ...
    pear:       { frequency: 5.981 },
    melon:      { frequency: 16.29 },
    grapes:     { frequency: 3.459 },
