...
export const FREQUENCY_REEL1 = {
  ...
  symbols: {
    bar:        { frequency: 13.94 },
    clover:     { frequency: 13.5 },
    pear:       { frequency: 13.77 },
    melon:      { frequency: 14.08 },
    grapes:     { frequency: 9.195 },
    plum:       { frequency: 9.724 },
    orange:     { frequency: 10.53 },
    cherries:   { frequency: 11.26 },
...
export const FREQUENCY_REEL2 = {
  ...
  symbols: {
    bar:        { frequency: 8.613 },
    clover:     { frequency: 8.595 },
    pear:       { frequency: 11.33 },
    melon:      { frequency: 11.55 },
    grapes:     { frequency: 10.08 },
    plum:       { frequency: 13.57 },
    orange:     { frequency: 11.14 },
    cherries:   { frequency: 21.13 },
    star:       { frequency: 0, fixed: true, minFrequency: 0, maxFrequency: 0 },
    strawberry: { frequency: 0, fixed: true, minFrequency: 0, maxFrequency: 0 },
  },
};
...
export const FREQUENCY_REEL3 = {
  ...
  symbols: {
    bar:        { frequency: 10.79 },
    clover:     { frequency: 9.203 },
    pear:       { frequency: 9.841 },
    melon:      { frequency: 9.719 },
    grapes:     { frequency: 10.58 },
    plum:       { frequency: 9.773 },
    orange:     { frequency: 10.35 },
    cherries:   { frequency: 8.974 },
    star:       { frequency: 30.19, minGap: 3, maxStack: 1, minFrequency: 1, maxFrequency: 30 },
    strawberry: { frequency: 6.583, minGap: 3, maxStack: 1, minFrequency: 1, maxFrequency: 6 },
  },
};
...
function buildPaytableContent() {
  renderLinePaytable({ container: document.getElementById('paytable-grid-content'), paytable: PAYTABLE, paylines: PAYLINES, reelsCount: REELS_COUNT, assets: engine?.assets, paylinePreviewContainer: document.getElementById('paylines-preview') });
}
