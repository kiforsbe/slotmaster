...
export const FREQUENCY_REEL1 = {
  ...
  symbols: {
    bar:        { frequency: 14.23 },
    clover:     { frequency: 12.71 },
    pear:       { frequency: 13.44 },
    melon:      { frequency: 11.58 },
    grapes:     { frequency: 11.65 },
    plum:       { frequency: 11.45 },
    orange:     { frequency: 10.11 },
    cherries:   { frequency: 10.83 },
...
export const FREQUENCY_REEL2 = {
  ...
  symbols: {
    bar:        { frequency: 8.98 },
    clover:     { frequency: 10.3 },
    pear:       { frequency: 11.06 },
    melon:      { frequency: 11.62 },
    grapes:     { frequency: 12.75 },
    plum:       { frequency: 13.17 },
    orange:     { frequency: 13.97 },
    cherries:   { frequency: 14.17 },
    star:       { frequency: 0, fixed: true, minFrequency: 0, maxFrequency: 0 },
    strawberry: { frequency: 0, fixed: true, minFrequency: 0, maxFrequency: 0 },
  },
};
...
export const FREQUENCY_REEL3 = {
  ...
  symbols: {
    bar:        { frequency: 9.906 },
    clover:     { frequency: 11.18 },
    pear:       { frequency: 10.27 },
    melon:      { frequency: 11.44 },
    grapes:     { frequency: 10.04 },
    plum:       { frequency: 10.29 },
    orange:     { frequency: 10.1 },
    cherries:   { frequency: 5.856 },
    star:       { frequency: 30.15, minGap: 3, maxStack: 1, minFrequency: 1, maxFrequency: 30 },
    strawberry: { frequency: 6.755, minGap: 3, maxStack: 1, minFrequency: 1, maxFrequency: 6 },
  },
};
