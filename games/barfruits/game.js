...
export const FREQUENCY_REEL1 = {
  ...
  symbols: {
    bar_triple: { frequency: 0.8466 },
    bar_double: { frequency: 0.471 },
    bar:        { frequency: 0.509 },
    bell:       { frequency: 0.723 },
    clover:     { frequency: 0.3836 },
    strawberry: { frequency: 0.4011 },
    plum:       { frequency: 0.471 },
    grapes:     { frequency: 0.4321 },
    orange:     { frequency: 0.3992 },
    melon:      { frequency: 0.3634 },
...
export const FREQUENCY_REEL2 = {
  defaults: { minFrequency: 0, maxFrequency: 1 },
  symbols: {
    bar_triple: { frequency: 0.5819 },
    bar_double: { frequency: 0.5548 },
    bar:        { frequency: 0.6411 },
    bell:       { frequency: 0.4627 },
    clover:     { frequency: 0.6219 },
    strawberry: { frequency: 0.4538 },
    plum:       { frequency: 0.4426 },
    grapes:     { frequency: 0.4131 },
    orange:     { frequency: 0.4355 },
    melon:      { frequency: 0.3925 },
    star:       { frequency: 0.1715, minGap: 3, maxStack: 1 },
  },
};
...
export const FREQUENCY_REEL3 = {
  defaults: { minFrequency: 0, maxFrequency: 1 },
  symbols: {
    bar_triple: { frequency: 0.02096 },
    bar_double: { frequency: 0.09239 },
    bar:        { frequency: 0.1324 },
    bell:       { frequency: 0.09284 },
    clover:     { frequency: 0.4005 },
    strawberry: { frequency: 0.6751 },
    plum:       { frequency: 0.7593 },
    grapes:     { frequency: 0.9269 },
    orange:     { frequency: 0.7656 },
    melon:      { frequency: 1.134 },
    star:       { frequency: 0.1715, minGap: 3, maxStack: 1 },
  },
};
...
export const FREQUENCY_REEL4 = {
  defaults: { minFrequency: 0, maxFrequency: 1 },
  symbols: {
    bar_triple: { frequency: 0.1936 },
    bar_double: { frequency: 0.1928 },
    bar:        { frequency: 0.1552 },
    bell:       { frequency: 0.3364 },
    clover:     { frequency: 0.4726 },
    strawberry: { frequency: 0.5185 },
    plum:       { frequency: 0.5051 },
    grapes:     { frequency: 0.4406 },
    orange:     { frequency: 0.7409 },
    melon:      { frequency: 1.444 },
    star:       { frequency: 0.1715, minGap: 3, maxStack: 1 },
  },
};
...
export const FREQUENCY_REEL5 = {
  defaults: { minFrequency: 0, maxFrequency: 1 },
  symbols: {
    bar_triple: { frequency: 0.689 },
    bar_double: { frequency: 0.3071 },
    bar:        { frequency: 0.3991 },
    bell:       { frequency: 3.177e-12 },
    clover:     { frequency: 0.0581 },
    strawberry: { frequency: 0.8095 },
    plum:       { frequency: 0.4958 },
    grapes:     { frequency: 0.995 },
    orange:     { frequency: 0.7761 },
    melon:      { frequency: 0.4702 },
    star:       { frequency: 0.1715, minGap: 3, maxStack: 1 },
  },
};
